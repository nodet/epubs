...
ABBR="jp-ii" 
FULL="john_paul_ii"
UUID="3de381d5-a71f-4bdf-962a-2bc36abab4d6"
OUTPUT="Encycliques-Jean-Paul-II.epub"     
...
do           
  ...
  perl -e '
	  ...
	  $text =~ s/EGLISE/\&Eacute;GLISE/g;
	  $text =~ s/EVANGILE/\&Eacute;VANGILE/g;
	  $text =~ s/EVEQUE/\&Eacute;V\&Ecirc;QUE/g;
	  $text =~ s/PRETRES/PR\&Ecirc;TRES/g;
	  $text =~ s/ONZIEME/ONZI\&Egrave;ME/g;
	  $text =~ s/OEUVRE/\&OElig;UVRE/g;
	  $text =~ s/EVANGELISATION/\&Eacute;VANG\&Eacute;LISATION/g;
	  $text =~ s/A TOUS/\&Agrave; TOUS/g;
	  $text =~ s/A L(.)OCCASION/\&Agrave; L$1OCCASION/g;
	  $text =~ s/METHODE/M\&Eacute;THODE/g;
	  $text =~ s/PORTEE/PORT\&Eacute;E/g;
	  $text =~ s/CHRETIEN/CHR\&Eacute;TIEN/g;
	  $text =~ s/MILLENAIRE/MILL\&Eacute;NAIRE/g;
	  ...
	  $text =~ s/IMPLANTERENT/IMPLANT\&Egrave;RENT/g;
      # Fix typos
	  $text =~ s/Incarnation ed la/Incarnation de la/g; 
	  $text =~ s/mul- tiples/multiples/g;
	  $text =~ s/subis- sent/subissent/g;
	  $text =~ s/lui- m(.)me/lui-m$1me/g;
	  $text =~ s/sh<sup>e<\/sup>ma/shema/g;     
	  $text =~ s/Elle est<br \/>/Elle est/g;
	  $text =~ s/>A />\&Agrave; /g;
	  $text =~ s/> A /> \&Agrave; /g;
	  $text =~ s/\. A /. \&Agrave; /g; 
	  $text =~ s/encore \? J\&eacute;sus/encore ? \&quot; J\&eacute;sus/;
	  $text =~ s/<\/span>\s*<p[^>]*>\(368\)\.<\/p>/ \(368\)\.<br \/>\n         <br \/><\/span>/;
	  $text =~ s/suismoi/suis-moi/;
	  $text =~ s/L '"'"'/L'"'"'/g; 
  	  $text =~ s/<p class="style2">C'"'"'est pourquoi, apr.*\[\&hellip;\]<\/i><\/p>/<p class="style2">C'"'"'est pourquoi, apr\&egrave;s l'"'"'importante pr\&eacute;cision \&laquo; un seul est le Bon \&raquo;, J\&eacute;sus r\&eacute;pond au jeune homme : \&laquo; Si tu veux entrer dans la vie, observe les commandements \&raquo; \(Mt 19, 17). De cette mani\&egrave;re est \&eacute;nonc\&eacute; <i>un lien \&eacute;troit entre la vie \&eacute;ternelle et l'"'"'ob\&eacute;issance aux commandements<\/i> : les commandements de Dieu montrent \&agrave; l'"'"'homme le chemin de la vie et qu'"'"'ils y m\&egrave;nent. De la bouche m\&ecirc;me de J\&eacute;sus, nouveau Mo\&iuml;se, l'"'"'homme est une fois de plus donn\&eacute; les commandements  du D\&eacute;calogue. J\&eacute;sus lui-m\&ecirc;me les confirme d\&eacute;finitivement et nous les propose comme le moyen et la condition du salut. <i>Les commandements sont li\&eacute;s \&agrave; une promesse<\/i>. Dans l'"'"'Ancien Testament l'"'"'objet de la promesse \&eacute;tait la possession d'"'"'une terre o\&ugrave; les gens seraient en mesure de vivre en libert\&eacute; et en conformit\&eacute; avec la justice \(cf. Dt 6, 20-25\). Dans la Nouvelle Alliance, l'"'"'objet de la promesse est le \&laquo; Royaume des cieux \&raquo;, comme J\&eacute;sus le d\&eacute;clare au d\&eacute;but du \&laquo; Sermon sur la montagne \&raquo; - un sermon qui contient la formulation la plus compl\&egrave;te de la loi nouvelle \(cf. Mt 5-7\), clairement li\&eacute;e au D\&eacute;calogue, confi\&eacute; par Dieu \&agrave; Mo\&iuml;se sur le mont Sina\&iuml;. Cette m\&ecirc;me r\&eacute;alit\&eacute; du Royaume est mentionn\&eacute;e dans l'"'"'expression \&laquo;vie \&eacute;ternelle\&raquo;, qui est une participation \&agrave; la vie m\&ecirc;me de Dieu. Il n'"'"'est atteint dans sa perfection qu'"'"'apr\&egrave;s la mort, mais dans la foi, il est d\&eacute;j\&agrave; aujourd'"'"'hui une lumi\&egrave;re de la v\&eacute;rit\&eacute;, une source de sens pour la vie, une part imparfait en ce qui suit parfaite de Christ. En effet, J\&eacute;sus dit \&agrave; ses disciples apr\&egrave;s avoir parl\&eacute; au jeune homme riche: \&laquo; Et quiconque aura quitt\&eacute;, \&agrave; cause de mon nom, ses fr\&egrave;res, ou ses s\&oelig;urs, ou son p\&egrave;re, ou sa m\&egrave;re, ou sa femme, ou ses enfants, ou ses terres, ou ses maisons, recevra le centuple, et h\&eacute;ritera la vie \&eacute;ternelle \&raquo; \(Mt 19, 29\).<\/p>/;
      $text =~ s/\b([IXV][IXV]*)(er?)\b/<span style="font-size: smaller">$1<\/span><sup>$2<\/sup>/g;
	  # Fix bad html
